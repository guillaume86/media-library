(function() {
  var Datastore, EventEmitter, MediaLibrary, async, compare, escapeRegExp, fs, getPathRegex, immediatly, indexer, mapPathToFolder, mapTrackToFile, path, _, _ref;
  ...
  _ref = require('./utils'), compare = _ref.compare, escapeRegExp = _ref.escapeRegExp, mapPathToFolder = _ref.mapPathToFolder, mapTrackToFile = _ref.mapTrackToFile, getPathRegex = _ref.getPathRegex, immediatly = _ref.immediatly;
    ...
    MediaLibrary.prototype.tracks = function(query, callback) {
      ...
      return this.db.find(q, function(err, tracks) {
        ...
        tracks.sort(function(t1, t2) {
          ...
          c = compare((_ref1 = t1.artist) != null ? _ref1[0] : void 0, (_ref2 = t2.artist) != null ? _ref2[0] : void 0);
          if (c !== 0) {
            return c;
          }
          ...
          return compare((_ref3 = t1.track) != null ? _ref3.no : void 0, (_ref4 = t2.track) != null ? _ref4.no : void 0);
        });
        return callback(null, tracks);
      });
    };
    ...
    MediaLibrary.prototype.albums = function(query, callback) {
      ...
      return this.db.find(q, function(err, tracks) {
        ...
        albumtracks = tracks.filter(function(track) {
          ...
          return {
            title: track.album,
            artist: ((_ref1 = track.albumartist) != null ? _ref1[0] : void 0) || ((_ref2 = track.artist) != null ? _ref2[0] : void 0),
            path: track.path,
            dirpath: path.dirname(track.path),
            track_no: (_ref3 = track.track) != null ? _ref3.no : void 0,
            year: track.year,
            _id: track._id
          };
        });
