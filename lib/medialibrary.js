(function() {
  var Datastore, EventEmitter, MediaLibrary, async, compare, escapeRegExp, fs, getPathRegex, indexer, mapPathToFolder, mapTrackToFile, path, _, _ref;
  ...
  _ref = require('./utils'), compare = _ref.compare, escapeRegExp = _ref.escapeRegExp, mapPathToFolder = _ref.mapPathToFolder, mapTrackToFile = _ref.mapTrackToFile, getPathRegex = _ref.getPathRegex;
