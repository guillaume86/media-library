(function() {
  var Datastore, EventEmitter, MediaLibrary, assign, async, compare, escapeRegExp, fs, getPathRegex, groupBy, imageIndexer, immediatly, indexer, mapPathToFolder, mapTrackToFile, path, _, _ref, _ref1;
  ...
  _ref = require('lodash'), assign = _ref.assign, groupBy = _ref.groupBy;

  indexer = require('./musicindexer');

  imageIndexer = require('./imageindexer');

  _ref1 = require('./utils'), compare = _ref1.compare, escapeRegExp = _ref1.escapeRegExp, mapPathToFolder = _ref1.mapPathToFolder, mapTrackToFile = _ref1.mapTrackToFile, getPathRegex = _ref1.getPathRegex, immediatly = _ref1.immediatly;
    ...
    MediaLibrary.prototype.scanCovers = function(callback) {
      ...
      return async.mapSeries(this.options.paths, function(dir, callback) {
        ...
        return self.tracks(function(err, tracks) {
          ...
          tracksImages = tracksImages.filter(function(_arg) {
            var images;
            images = _arg.images;
            return !!images;
          });
          return async.mapSeries(tracksImages, function(_arg, callback) {
            var covers, images, tracks;
            tracks = _arg.tracks, images = _arg.images;
    ...
    MediaLibrary.prototype.tracks = function(query, callback) {
      ...
      return this.db.find(q, function(err, tracks) {
        ...
        tracks.sort(function(t1, t2) {
          var c, _ref2, _ref3, _ref4, _ref5;
          c = compare((_ref2 = t1.artist) != null ? _ref2[0] : void 0, (_ref3 = t2.artist) != null ? _ref3[0] : void 0);
          if (c !== 0) {
            return c;
          }
          ...
          return compare((_ref4 = t1.track) != null ? _ref4.no : void 0, (_ref5 = t2.track) != null ? _ref5.no : void 0);
        });
        return callback(null, tracks);
      });
    };
    ...
    MediaLibrary.prototype.albums = function(query, callback) {
      ...
      return this.db.find(q, function(err, tracks) {
        ...
        albumtracks = tracks.filter(function(track) {
          ...
          return {
            title: track.album,
            artist: ((_ref2 = track.albumartist) != null ? _ref2[0] : void 0) || ((_ref3 = track.artist) != null ? _ref3[0] : void 0),
            path: track.path,
            dirpath: path.dirname(track.path),
            track_no: (_ref4 = track.track) != null ? _ref4.no : void 0,
            year: track.year,
            _id: track._id
          };
        });
